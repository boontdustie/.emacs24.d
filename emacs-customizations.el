...
(custom-set-faces
 ...
 '(magit-diff-context-highlight ((t (:background "black" :foreground "color-250"))))
 '(magit-diff-lines-heading ((t (:inherit magit-diff-hunk-heading-highlight :background "black"))))
 '(magit-diff-our ((t (:background "black" :foreground "red"))))
 '(magit-diff-our-highlight ((t (:foreground "brightred"))))
 '(magit-diff-removed ((t (:background "black" :foreground "red"))))
 '(magit-diff-removed-highlight ((t (:background "color-232" :foreground "red"))))
 '(magit-diff-their ((t (:background "black" :foreground "color-46"))))
 '(magit-diff-their-highlight ((t (:foreground "color-46"))))
 '(magit-diffstat-added ((t (:foreground "color-47"))))
 ...
 '(org-scheduled-previously ((t (:foreground "brightgreen"))))
 ...
 '(web-mode-html-tag-face ((t (:foreground "color-247")))))
